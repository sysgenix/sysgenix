    ...
    <>     
     <nav className={styles.MainNavbar}>
        ...
        <Link
            ...
            className={`inline-block border border-[#de4b5c] bg-transparent font-semibold py-3 px-8 tracking-wider cursor-pointer transition-colors duration-300 hover:bg-[#c93d4e]
              ${isFixed ? 'text-[#de4b5c]' : 'text-white'} ${isFixed ? 'hover:bg-[#ffffff]' : 'hover:bg-[#c93d4e]'}
            `}
          >
            +1-639-998-0063
          </Link>
        <Link href="/contact-us" className="inline-block border border-[#de4b5c] bg-[#de4b5c] text-white font-semibold py-3 px-8  hover:bg-[#c93d4e] transition-colors duration-300 tracking-wider cursor-pointer">Get a Quote</Link>
    </nav>
    </>
  );
}
