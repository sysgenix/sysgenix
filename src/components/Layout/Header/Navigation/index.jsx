  ...
  return (
    <>     
     <nav className={styles.MainNavbar}>
        ...
        <Link href="/contact-us" className="inline-flex items-center gap-2 border border-[#fc1660] bg-[#fc1660] text-white font-semibold py-2 px-4  hover:bg-gray-900 transition-colors duration-300 tracking-wider cursor-pointer"><Image src="/images/header/quote.gif" alt='Call - Sysgenix ' width={25} height={25}/>Get a Quote</Link>
    </nav>
    </>
  );
}
